      ...
      subSections: [
        {
          ...
          icon: Users,
          items: [
            { label: 'Students', href: `${basePath}/students`, icon: Users, exact: true },
            { label: 'Direct Admission', href: `${basePath}/students/admissions`, icon: UserPlus },
            { label: 'Online Applications', href: `${basePath}/students/applications`, icon: ClipboardList },
