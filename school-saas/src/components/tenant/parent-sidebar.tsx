...
import { LayoutDashboard, UsersRound, Wallet, Calendar, FileText, Bell, MessageSquare } from 'lucide-react';
import { cn } from '@/lib/utils';
import { useSidebar } from './sidebar-provider';

export function ParentSidebar({ tenantSlug, tenantName, primaryColor }: { tenantSlug: string, tenantName: string, primaryColor?: string }) {
  ...
  const navItems = [
    ...
    { label: 'My Children', href: `${basePath}/children`, icon: UsersRound },
    { label: 'Fees & Payments', href: `${basePath}/fees`, icon: Wallet },
