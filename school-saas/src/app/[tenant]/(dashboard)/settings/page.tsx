          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-xl border border-[hsl(var(--accent)/0.3)] bg-[hsl(var(--accent)/0.05)]">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="px-2.5 py-1 rounded-full text-[10px] font-semibold bg-emerald-500/15 text-emerald-400 border border-emerald-500/20">ACTIVE</span>
              </div>
              <div className="space-y-2">
                {[
                  ...
                  <div key={term.name} className="flex items-center justify-between py-2 px-3 rounded-lg bg-[hsl(var(--bg-primary)/0.5)]">
                    <span className="text-sm text-[hsl(var(--text-primary))]">{term.name}</span>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-2xl bg-[hsl(var(--accent)/0.1)] flex items-center justify-center text-[hsl(var(--accent))]"><School className="w-8 h-8" /></div>
                <button className="px-4 py-2 rounded-lg border border-[hsl(var(--border))] text-sm text-[hsl(var(--text-secondary))] hover:bg-[hsl(var(--bg-tertiary))] transition-colors">Upload Logo</button>
              </div>
            </div>
            <div>
        ...
        <div className="glass-card p-6 space-y-6 animate-fade-in">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={user.email} className="flex items-center justify-between p-3 rounded-xl hover:bg-[hsl(var(--bg-tertiary)/0.5)] transition-colors">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[hsl(var(--accent)/0.2)] to-[hsl(var(--info)/0.2)] flex items-center justify-center text-[hsl(var(--accent))] text-xs font-bold">
