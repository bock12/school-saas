...
export default function ExaminationsDashboardPage() {
  ...
  const quickActions = [
    { label: 'Create Examination', desc: 'Add new session exams', href: `/admin/academics/examinations/list`, icon: FlaskConical, primary: true },
    { label: 'Generate Timetable', desc: 'Create exam rooms list', href: `/admin/academics/examinations/timetable`, icon: Clock },
    { label: 'Open Marks Entry', desc: 'Secure marks entry screen', href: `/admin/academics/examinations/marks`, icon: Edit2 },
    { label: 'Moderate Results', desc: 'HOD review variance check', href: `/admin/academics/examinations/moderation`, icon: ClipboardList },
    { label: 'Approve Results', desc: 'Verify and sign grade registers', href: `/admin/academics/examinations/approval`, icon: ShieldCheck },
    { label: 'Publish Results', desc: 'Enable student portal visibility', href: `/admin/academics/examinations/publish`, icon: FileText },
    { label: 'Generate Report Cards', desc: 'Compile PDF student profiles', href: `/admin/academics/examinations/report-cards`, icon: Award }
  ];
