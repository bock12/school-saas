...
export default function AcademicsDashboardPage() {
  ...
  const quickActions = [
    { label: 'Create Subject', desc: 'Add new weighted curriculum subject', href: `/admin/academics/subjects`, icon: BookMarked, primary: true },
    { label: 'Create Class', desc: 'Define grade capacity levels', href: `/admin/academics/classes`, icon: GraduationCap },
    { label: 'Create Stream', desc: 'Create science, arts stream groups', href: `/admin/academics/streams`, icon: Users },
    { label: 'Assign Teacher', desc: 'Setup academic workload ratios', href: `/admin/academics/teacher-allocation`, icon: UsersRound },
    { label: 'Assign Subject', desc: 'Allocate course links to timetable', href: `/admin/academics/course-allocation`, icon: Layers },
    { label: 'Publish Academic Calendar', desc: 'Distribute term deadlines calendar', href: `/admin/academics/calendar`, icon: CalendarCheck },
    { label: 'Configure Grading', desc: 'Configure percentage GPA tables', href: `/admin/academics/grading`, icon: BarChart3 },
    { label: 'Configure Assessment Rules', desc: 'Configure continuous assessment weightings', href: `/admin/academics/assessment-rules`, icon: ClipboardList }
  ];
