...
export default function StaffDashboardPage() {
  ...
  const quickActions = [
    { label: 'Add Staff', desc: 'Register new employee record', href: `/admin/staff/employees`, icon: UserPlus, primary: true },
    { label: 'Start Recruitment', desc: 'Publish a job vacancy', href: `/admin/staff/recruitment`, icon: Briefcase },
    { label: 'Assign Role', desc: 'Configure system roles', href: `/admin/staff/bulk`, icon: Settings },
    { label: 'Assign Department', desc: 'Move employee structures', href: `/admin/staff/departments`, icon: Layers },
    { label: 'Upload Contract', desc: 'Attach signed PDF contract', href: `/admin/staff/contracts`, icon: FileText },
    { label: 'Approve Leave', desc: 'Approve leave request forms', href: `/admin/staff/leave`, icon: Clock },
    { label: 'Mark Attendance', desc: 'Roster check-ins override', href: `/admin/staff/attendance`, icon: CheckSquare },
    { label: 'Generate Staff ID', desc: 'Auto-identity pool config', href: `/admin/staff/bulk`, icon: Award },
    { label: 'Print ID Card', desc: 'Batch ID card prints', href: `/admin/staff/bulk`, icon: LayoutGrid },
    { label: 'Export Staff List', desc: 'Download rosters', href: `/admin/staff/bulk`, icon: Download },
  ];
