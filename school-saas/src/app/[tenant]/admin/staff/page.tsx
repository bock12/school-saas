  ...
  const hcmModules = [
    {
      ...
      count: '84 Employees',
      desc: 'Unified master roster of teaching faculty (48) and support personnel (36)',
    ...
    },
    {
      ...
      count: '6 Departments',
      desc: 'Organize academic faculties, administrative branches & department chairs',
    ...
    },
    {
      ...
      count: '14 Positions',
      desc: 'Job architecture, structural titles & permission scope mapping',
      href: `/admin/staff/positions`,
      icon: BookOpen,
