    ...
    <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-2">
              <span className="text-3xl font-black text-[hsl(var(--text-primary))]">
                SLE {(billingCycle === 'yearly' ? (currentPlan?.price_yearly ?? 0) : (currentPlan?.price_monthly ?? 0))}
              </span>
            ...
            return (
              <div key={plan.id} className={cn('glass-card p-5 space-y-4 relative flex flex-col',
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <span className="text-2xl font-black text-[hsl(var(--text-primary))]">SLE {price}</span>
          ...
          <div className="divide-y divide-[hsl(var(--border)/0.5)]">
            {MOCK_INVOICES.map(inv => (
              <div key={inv.id} className="flex items-center gap-4 px-5 py-4 hover:bg-[hsl(var(--bg-tertiary)/0.3)] transition-colors">
                ...
                <span className="text-sm font-bold text-[hsl(var(--text-primary))]">SLE {inv.amount}</span>
      ...
      {tab === 'payment' && (
        <div className="glass-card p-6 space-y-5 max-w-md">
          <h3 className="text-sm font-bold text-[hsl(var(--text-primary))]">Payment Methods</h3>
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-zinc-800 to-zinc-700 border border-zinc-600 relative overflow-hidden">
              ...
              <div className="flex justify-between items-start mb-4">
                <p className="text-[10px] text-zinc-400 uppercase tracking-wider">Visa ending in 4242</p>
                <span className="px-2 py-0.5 rounded text-[10px] bg-emerald-500/20 text-emerald-400 font-bold uppercase">Default</span>
              </div>
              <p className="text-xl font-mono font-bold text-white tracking-widest">•••• •••• •••• 4242</p>
            </div>

            {/* Mobile Money */}
            <div className="p-4 rounded-xl bg-[hsl(var(--bg-tertiary))] border border-[hsl(var(--border))] flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-orange-500/10 flex items-center justify-center">
                  <span className="text-orange-500 font-bold text-[10px]">MoMo</span>
                </div>
                <div>
                  <p className="text-sm font-semibold text-[hsl(var(--text-primary))]">Mobile Money</p>
                  <p className="text-xs text-[hsl(var(--text-tertiary))]">Orange / Africell / QCell</p>
                </div>
              </div>
              <button className="px-3 py-1.5 rounded-lg border border-[hsl(var(--border))] text-xs font-semibold text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--text-primary))] hover:border-[hsl(var(--accent)/0.3)] hover:bg-[hsl(var(--accent)/0.05)] transition-colors">Setup</button>
            </div>
            ...
            <div className="p-4 rounded-xl bg-[hsl(var(--bg-tertiary))] border border-[hsl(var(--border))] flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-blue-500/10 flex items-center justify-center">
                  <span className="text-blue-500 font-bold text-[10px]">MNM</span>
                </div>
                <div>
                  <p className="text-sm font-semibold text-[hsl(var(--text-primary))]">Monime Payment</p>
                  <p className="text-xs text-[hsl(var(--text-tertiary))]">Direct / Digital Wallet</p>
                </div>
              </div>
              <button className="px-3 py-1.5 rounded-lg border border-[hsl(var(--border))] text-xs font-semibold text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--text-primary))] hover:border-[hsl(var(--accent)/0.3)] hover:bg-[hsl(var(--accent)/0.05)] transition-colors">Setup</button>
            </div>
          ...
          <p className="text-[11px] text-[hsl(var(--text-tertiary))]">Payments processed securely. Details are never stored on our servers.</p>
        </div>
      )}
